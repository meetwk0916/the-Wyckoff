...
- 已在实际 ptrade 环境验证 `tools/ptrade_phase1_validation.py` 的 JSON / sqlite3 无 HTTP 默认落盘链路可用。
...
2. 粘贴 `strategy/ptrade_wyckoff_trader.py` 的内容。
	ptrade 路线文档统一从 `../docs/ptrade-wyckoff/README.md` 进入；当前操作说明见 `../docs/ptrade-wyckoff/PTRADE-TRADING.md`。
